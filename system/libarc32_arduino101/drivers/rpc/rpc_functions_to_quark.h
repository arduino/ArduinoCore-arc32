...
#define LIST_FN_SIG_S						\
	...
	FN_SIG_S(on_nble_dtm_rsp,				\
		const struct nble_dtm_rsp *)			\
	FN_SIG_S(on_nble_gap_rpa_update_evt,			\
		const struct nble_gap_rpa_update_evt *)		\
	FN_SIG_S(on_nble_storage_read_evt,			\
		 const struct nble_storage_read_evt *)
...
#define LIST_FN_SIG_S_B						\
	...
	FN_SIG_S_B(on_nble_uart_test_evt,			\
		   ...
		   const uint8_t *, uint8_t)			\
	FN_SIG_S_B(on_nble_storage_write_evt,			\
		   const struct nble_storage_write_evt *,	\
